...
caminho = os.path.join('C:\\home\\users\\', 'Desktop', 'curso', 'arquivo.txt')
caminho_real = "C:\\Python3\\Python_Modulos\\aula171.py"
...
print(os.path.exists(caminho_real))
print('¬'* 30)
print(os.path.abspath('.'))
print(os.path.basename(caminho_real))
print(os.path.dirname(caminho_real))
