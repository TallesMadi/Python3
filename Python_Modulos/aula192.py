...
CAMINHO_ZIP_DIR = CAMINHO_RAIZ / 'aula_192_diretorio_zip'
CAMINHO_COMPACTADO = CAMINHO_RAIZ / 'aula192_compactado.zip'
CAMINHO_DESCOMPACTADO = CAMINHO_RAIZ / 'aula192_descompactado'
...
#  criar zip e adicionar arquivos
